# Seedance cross-agent skills

本專案提供三個共用 canonical skills；Codex 與 Claude Code 透過各自的 project-local symlink 讀取同一份內容。
...
三個 skills 都支援 description-based automatic invocation。
...
Skills 會以使用者語言回答；若詢問「目前／最新」能力或參數，應先核對實際平台的現行官方文件。研究知識封存日為 2026-08-22。
